        ...
        <form class="register_form" name="register_form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            <div class="form-field">
                <label for="username">Naam:</label><span><br>
                    <input type="text" id="username" name="_username" class="input_reg" autocomplete="off" />
                </span>
            </div>
            <div class="form-field">
                <label for="email">Email:</label><span><br>
                    <input type="text" id="email" name="_email" class="input_reg" autocomplete="off" />
                </span>
            </div>
            <div class="form-field">
                <label for="credentials">Wachtwoord:</label><span><br>
                    <input type="password" id="credentials" name="_passwd" class="input_reg" autocomplete="off" />
                </span>
            </div>
            <div class="form-field">
                <label for="credentials">Geslacht:</label><span><br>
                    ...
                    <input type="radio" id="vrouw" name="gender" />
